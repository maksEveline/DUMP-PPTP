...
Главное меню:
    ...
    new_refferal = (
        "<b>💎 У вас новый реферал! @{user_name} \n"
...
"""
    ...
    promo_act = (
        "<b>📩 Для активации промокода напишите его название</b>\n"
    ...
    next_lvl_remain = (
        "💚 До следующего уровня осталось пригласить <code>{remain_refs} чел</code></b>"
    )
    ref_text = (
...
👥 {} {}</b>"""
    ...
    conditions_channels = (
        "<b>✨ Подписаться на {num} {channels_text}: \n\n{channels}</b>\n"
    )
    ...
    search_request_text = (
        "<b>Введите название или часть названия позиции для поиска!</b>"
    )
    inf = "[Безлимит]"
    result_search = "Результат поиска!"
    nothing_search = "Ничего не найдено!"
