...
def admin_menu():
    ...
    keyboard.add(
        InlineKeyboardButton(
            text="Изменить новостной канал", callback_data="change_news_channel"
        )
    )
    keyboard.add(kb[11])
...
async def contests_inl():
    ...
    btn5 = InlineKeyboardButton(
        f"❌ Закончить розыгрыш сейчас", callback_data="cancel_contest_now"
    )
...
def cancel_contest_now_yes_no(contest_id):
    ...
    kb.append(
        InlineKeyboardButton(
            f"✅ Да, хочу", callback_data=f"cancel_contest_:yes:{contest_id}"
        )
    )
    kb.append(
        InlineKeyboardButton(
            f"❌ Нет, не хочу", callback_data=f"cancel_contest_:no:{contest_id}"
        )
    )
...
def extra_settings_inl():
    ...
    kb.append(
        InlineKeyboardButton(f"💎 Создать промокод", callback_data="promo_create")
    )
    kb.append(
        InlineKeyboardButton(f"🎲 Удалить промокод", callback_data="promo_delete")
    )
    kb.append(
        InlineKeyboardButton(
            f"2️⃣ Изменить кол-во рефералов для 2 лвла", callback_data="ref_lvl_edit:2"
        )
    )
    kb.append(
        InlineKeyboardButton(
            f"3️⃣ Изменить кол-во рефералов для 3 лвла", callback_data="ref_lvl_edit:3"
        )
    )
...
def pr_buttons_inl():
    ...
    kb.append(
        InlineKeyboardButton(f"+ Создать кнопку", callback_data="pr_button:create")
    )
    kb.append(
        InlineKeyboardButton(f"- Удалить кнопку", callback_data="pr_button:delete")
    )
    kb.append(InlineKeyboardButton(texts.back, callback_data="settings_back"))
...
def opr_mail_text():
    ...
    kb.append(
        InlineKeyboardButton("❌ Нет, не хочу", callback_data=f"mail_start_text:no")
    )
...
def opr_mail_photo():
    ...
    kb.append(
        InlineKeyboardButton("✅ Да, хочу", callback_data=f"mail_start_photo:yes")
    )
    kb.append(
        InlineKeyboardButton("❌ Нет, не хочу", callback_data=f"mail_start_photo:no")
    )
...
def products_edits():
    ...
    kb.append(
        InlineKeyboardButton("🗑️ | ВСЕ Под-Категории", callback_data=f"del_all_pod_cats")
    )
...
async def open_pod_cats_for_add_mail_btn(cat_id):
    ...
    keyboard.add(
        InlineKeyboardButton(texts.back, callback_data=f"add_mail_buttons:pod_category")
    )
...
async def open_pod_cats_for_pos_add_mail(cat_id):
    ...
    keyboard.add(
        InlineKeyboardButton(texts.back, callback_data=f"add_mail_buttons:position")
    )
...
def edit_cat_inl(cat_id):
    ...
    kb.append(
        InlineKeyboardButton(
            f"Изменить название", callback_data=f"edit_cat_name:{cat_id}"
        )
    )
...
def choose_del_cat(cat_id):
    ...
    kb.append(
        InlineKeyboardButton(f"✅ Да, хочу", callback_data=f"dels_cat:yes:{cat_id}")
    )
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_cat:no:{cat_id}")
    )
...
def choose_del_all_cats():
    ...
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_all_cat:no")
    )
...
def update_pod_cat_inl(pod_cat_id):
    ...
    kb.append(
        InlineKeyboardButton(
            f"Изменить название", callback_data=f"edit_pod_cat_name:{pod_cat_id}"
        )
    )
    kb.append(
        InlineKeyboardButton(f"Удалить", callback_data=f"del_pod_cat:{pod_cat_id}")
    )
...
def choose_del_pod_cat(pod_cat_id):
    ...
    kb.append(
        InlineKeyboardButton(
            f"✅ Да, хочу", callback_data=f"dels_pod_cat:yes:{pod_cat_id}"
        )
    )
    kb.append(
        InlineKeyboardButton(
            f"❌ Нет, не хочу", callback_data=f"dels_pod_cat:no:{pod_cat_id}"
        )
    )
...
def choose_del_all_pod_cats():
    ...
    kb.append(
        InlineKeyboardButton(f"✅ Да, хочу", callback_data=f"dels_all_pod_cats:yes")
    )
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_all_pod_cats:no")
    )
...
async def open_pod_cats_for_add_pos(cat_id):
    ...
    keyboard.add(
        InlineKeyboardButton(
            f"💎 Выбрать эту категорию", callback_data=f"add_poss_cat:{cat_id}"
        )
    )
...
def edit_pos_inl(pos_id):
    ...
    kb.append(
        InlineKeyboardButton(f"Название", callback_data=f"edit_name_pos:{pos_id}")
    )
    kb.append(
        InlineKeyboardButton(f"Описание", callback_data=f"edit_desc_pos:{pos_id}")
    )
    kb.append(InlineKeyboardButton(f"Фото", callback_data=f"edit_photo_pos:{pos_id}"))
    kb.append(
        InlineKeyboardButton(f"Тип товара", callback_data=f"edit_infinity_pos:{pos_id}")
    )
    kb.append(InlineKeyboardButton(f"Удалить", callback_data=f"edit_del_pos:{pos_id}"))
    kb.append(
        InlineKeyboardButton(
            f"Очистить товары", callback_data=f"edit_clear_items_pos:{pos_id}"
        )
    )
    kb.append(
        InlineKeyboardButton(
            f"Загрузить товары", callback_data=f"edit_upload_items_pos:{pos_id}"
        )
    )
...
def choose_del_pos(pos_id):
    ...
    kb.append(
        InlineKeyboardButton(f"✅ Да, хочу", callback_data=f"dels_pos:yes:{pos_id}")
    )
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_pos:no:{pos_id}")
    )
...
def choose_del_all_pos():
    ...
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_all_poss:no")
    )
...
def stop_add_items():
    ...
    keyboard.add(
        InlineKeyboardButton(f"❌ Закончить загрузку", callback_data=f"stop_add_items")
    )
...
def choose_del_all_items():
    ...
    kb.append(
        InlineKeyboardButton(f"❌ Нет, не хочу", callback_data=f"dels_all_items:no")
    )
...
def choose_clear_items_pos(pos_id):
    ...
    kb.append(
        InlineKeyboardButton(f"✅ Да, хочу", callback_data=f"clear_items:yes:{pos_id}")
    )
    kb.append(
        InlineKeyboardButton(
            f"❌ Нет, не хочу", callback_data=f"clear_items:no:{pos_id}"
        )
    )
